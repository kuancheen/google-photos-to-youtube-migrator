...
## [0.2.17 (Beta)] - 2025-12-27
### Fixed
- **Diagnostics**: Fixed broken deep link in "Configuration Audit" modal (now points to Credentials list instead of invalid specific key URL).
