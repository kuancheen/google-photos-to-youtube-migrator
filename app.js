...
const CONFIG = {
    SCOPES: 'https://www.googleapis.com/auth/photoslibrary https://www.googleapis.com/auth/userinfo.email',
    DISCOVERY_DOCS: [
...
class MediaMigrator {
    ...
    async init() {
        this.cacheDom();
        this.bindEvents();
        this.log(`System Requesting Scopes: <small>${CONFIG.SCOPES}</small>`, 'system');
